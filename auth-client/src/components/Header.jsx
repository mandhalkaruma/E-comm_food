...
import header from '../assets/food.avif'

const Header = () => {
    return (
        <div className='py-3 px-10 sm:px-4 md:px-4 lg:px-6'>
                ...
                <div className='grid grid-cols-1 relative lg:grid-cols-2 gap-8 items-center'>
                    <div className='lg:w-[32rem] w-full flex flex-col space-y-6'>
                        ...
                        <div className='lg:text-xl text-[#191919] md:text-lg text-base'>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut, illum! Cupiditate consequatur, eum ex possimus numquam sequi aperiam minima 
                        </div>
