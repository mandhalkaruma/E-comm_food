        ...
        <div className='py-3 px-10 sm:px-4 md:px-6 lg:px-6'>
            <div className='container mx-auto py-[2vh]'>
                <div className='grid grid-cols-1 relative lg:grid-cols-2 gap-8 items-center'>
                    <img src={chef} alt="" className='h-[25rem] mx-auto justify-end' />
                    <div className='w-full md:w-[32rem flex flex-col space-y-6]'>
                        ...
                        <div className='lg:text-lg text-[#191919] md:text-base text-sm'>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad illum dolores quae quas omnis saepe quia maiores laborum dolor sit!
                        </div>
